...
public class MemberDetails extends javax.swing.JFrame {
    ...
    public MemberDetails(String AdminId,String MemberId) {
        this.AdminId = AdminId;
        this.MemberId = MemberId;
        initComponents();
        arr = new ConnectMSSQL().getMemberInfo("where MemberId = "+MemberId);
        ...
        due.setText(Integer.toString(user.getDue()));
        seatNo.setText(user.getSeatNo());
        mealType.setText(user.getMealType());
    ...
    private void initComponents() {
        ...
        mealType = new javax.swing.JTextField();
        ...
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 400, 80, 30));
        ...
        jLabel3.setText("Due:");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 220, 90, 20));
        ...
        due.setPreferredSize(new java.awt.Dimension(59, 27));
        getContentPane().add(due, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 210, 190, 30));

        seatNo.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        seatNo.setEnabled(false);
        seatNo.setPreferredSize(new java.awt.Dimension(59, 27));
        ...
        profession.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        profession.setEnabled(false);
        profession.setPreferredSize(new java.awt.Dimension(59, 27));
        getContentPane().add(profession, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 440, 190, 30));

        mealType.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        mealType.setEnabled(false);
        mealType.setPreferredSize(new java.awt.Dimension(59, 27));
        ...
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 280, 90, 20));
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        new MemberEdit(user,AdminId).setVisible(true);
        this.setVisible(false);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        if(query==0)
        {
            try
            {
                new ConnectMSSQL().delete("Member", "where MemberId = '"+user.getMemberId()+"'");
                ...
                new Member(AdminId).setVisible(true);
                this.setVisible(false);
            }
            catch(Exception e)
            {
    ...
    private javax.swing.JTextField mealType;
